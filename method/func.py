...
def build_solver_args(config: CFETConfig) -> Namespace:
    ...
    values: dict[str, Any] = {
        ...
        "thumb_phase": True,
        "thumb_contact_targets": False,
        "thumb_cleanup_max_step": 0.025,
        "thumb_cleanup_line_search": 0.45,
        "thumb_cleanup_step_weight": 0.20,
        "thumb_cleanup_anchor_weight": 8.0,
        "thumb_cleanup_points_per_link": 64,
        "thumb_cleanup_k": 8,
        "thumb_cleanup_max_push": 0.004,
        "thumb_cleanup_push_weight": 650.0,
        "thumb_cleanup_accept_penetration_gain_mm": 0.10,
        "thumb_cleanup_accept_near_drop": 0.08,
        "thumb_cleanup_accept_distance_worsen_mm": 1.0,
        "thumb_targets": 2,
